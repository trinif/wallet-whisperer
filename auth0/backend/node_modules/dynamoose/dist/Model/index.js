...
class Model extends InternalPropertiesClass_1.InternalPropertiesClass {
    ...
    constructor(name, schema, options, _ModelStore) {
        ...
        this.setInternalProperties(internalProperties, {
            ...
            "schemaCorrectnessScores": (object, settings = {}) => {
                const schemas = this.getInternalProperties(internalProperties).schemas;
                const schemasTypePaths = schemas.map((schema) => {
                    const typePaths = schema.getTypePaths(object, Object.assign({ "type": "toDynamo", "includeAllProperties": true }, settings));
                ...
                const schemaCorrectnessScores = schemasTypePaths
                    .map((obj) => Object.values(obj).map((obj) => (obj === null || obj === void 0 ? void 0 : obj.matchCorrectness) || 0))
