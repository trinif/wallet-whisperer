...
class Condition extends InternalPropertiesClass_1.InternalPropertiesClass {
    ...
    constructor(object) {
        ...
        this.setInternalProperties(internalProperties, {
            "requestObject": async (models, settings = { "conditionString": "ConditionExpression", "conditionStringType": "string" }) => {
                const toDynamo = async (key, value) => {
                    ...
                    const newObj = await Item_1.Item.objectFromSchema(object, modelForObject.Model, { "type": "toDynamo", "modifiers": ["set"], "typeCheck": false, "mapAttributes": true });
