...
class Table extends InternalPropertiesClass_1.InternalPropertiesClass {
    ...
    constructor(instance, name, models, options = {}) {
        ...
        this.setInternalProperties(internalProperties, {
            ...
            "getIndexes": async () => {
                return (await Promise.all(this.getInternalProperties(internalProperties).models.map((model) => model.Model.getInternalProperties(internalProperties).getIndexes()))).reduce((result, indexes) => {
            ...
            "modelForObject": async (object, settings) => {
    ...
    query(conditionInitializer) {
        return new ItemRetriever_1.Query(this.getInternalProperties(internalProperties).models.map((model) => model.Model), conditionInitializer);
    }
}
exports.Table = Table;
